...
val red9 = Color(0XFFFF2D2D)
val yellow = Color(0XFFFECE3E)
val yellow1 = Color(0xFFFFB320)
val gold = Color(0xFFF7D567)
val gold1 = Color(0xFFFFA946)
val blue = Color(0XFFC9D8F2)
val blue1 = Color(0xFF0000FF)
val info = Color(0xFF018786)
val warn = Color(0xFFD87831)
val orange = Color(0XFFFF6D00)
val orange1 = Color(0XFFFF8A05)
val orange2 = Color(0xFFFFE5D2)
val orange3 = Color(0xFFDC4900)
